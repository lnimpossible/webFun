(function (global, factory) {
    ...
    var MoveLine = function MoveLine(map, userOptions) {
        ...
        function Marker(opts) {
            ...
            this.location = ol.proj.fromLonLat(opts.location); //换成墨卡托坐标
        ...
        var addMarkLine = function addMarkLine() {
            ...
            dataset.forEach(function (line, i) {
                // console.log([line.from.lnglat[0], line.from.lnglat[1]])
                // console.log([line.to.lnglat[0], line.to.lnglat[1]])
